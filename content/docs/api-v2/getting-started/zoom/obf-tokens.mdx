...
<Callout type="warn">
**Deadline:** March 2, 2026. After this date, bots joining external Zoom meetings without OBF tokens will fail to join.
</Callout>
...
|-----------|-------------|
| `bot_uuid` | The Meeting BaaS bot UUID |
| `extra` | URL-encoded JSON of the `extra` data from the bot request |

**Example request to your endpoint:**

```
GET https://your-api.com/zoom/obf-token?bot_uuid=abc-123-def&extra=%7B%22user_id%22%3A%22usr_456%22%7D
```
