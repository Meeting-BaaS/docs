...
_openapi:
  ...
  structuredData:
    ...
    contents:
      ...
      - content: >-
          join_at: ISO8601 timestamp when the bot should join the meeting.


          Cannot be in the past (with 1 minute leeway) and cannot be more than
          90 days in the future.


          Example: "2025-12-25T10:00:00Z"
      - content: data
      - content: 'data.bot_id: The UUID of the created scheduled bot'
      - content: success
