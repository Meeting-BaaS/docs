...
<Accordion items={[
  {
    value: 'calendar',
    title: 'Calendar Module Updates',
    content: 'Refinements in calendar data retrieval and event handling processes.'
  },
  {
    value: 'bots',
    title: 'Bot Service Enhancements',
    content: 'Improvements in bot-related error handling and public interfaces.'
  }
]} />
