...
<Accordion items={[
  {
    value: 'calendar-updates',
    title: 'Calendar Improvements',
    content: 'Enhanced event filtering, improved attendee information management, and more robust credential handling.'
  },
  {
    value: 'security-updates',
    title: 'Security Enhancements',
    content: 'Addressed potential SQL injection vulnerabilities and improved overall system security.'
  }
]} />
