...
<Accordion items={[
  {
    ...
    title: 'Token and Email Handling',
    content: 'Fixed issues related to insufficient token detection and email cooldown checks.'
  },
  {
    value: 'streaming-improvements',
    title: 'Streaming and Service Enhancements',
    content: 'Refined streaming service, improved error handling, and updated instance management processes.'
  }
]} />
