...
<Callout type="warn">
  **New in v6.0.0**: Dual API support for both v1 and v2 APIs with type-safe version selection. Fully backward compatible with v5.x.
  See our [Migration to v2 API Guide](/docs/typescript-sdk/migration-to-v2) for detailed upgrade instructions.
</Callout>
