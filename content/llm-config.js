...
export const categoryConfig = {
  ...
  'api/all': {
    ...
    patterns: ['./content/docs/api/reference/**/*.mdx'],
  },
  'api/calendars': {
  ...
  'mcp-servers': {
    ...
    patterns: ['./content/docs/mcp-servers/**/*.mdx'],
  },
  'speaking-bots': {
  ...
  'typescript-sdk/all': {
    ...
    patterns: ['./content/docs/typescript-sdk/reference/**/*.mdx'],
  },
  'typescript-sdk/bots': {
  ...
  'typescript-sdk-webhooks': {
    ...
    description:
      'webhooks integration methods and types in the TypeScript SDK.',
    patterns: ['./content/docs/typescript-sdk/reference/webhooks/**/*.mdx'],
  },
  updates: {
    title: 'updates Documentation',
    description: 'Documentation for updates.',
    patterns: ['./content/docs/updates/**/*.mdx'],
  },
};
...
export const knownTxtPaths = [
  ...
  ['llms', 'mcp-servers'],
  ['llms', 'speaking-bots'],
  ['llms', 'speaking-bots', 'all'],
  ['llms', 'speaking-bots', 'bots'],
  ['llms', 'speaking-bots', 'system'],
  ['llms', 'transcript-seeker'],
  ['llms', 'typescript-sdk'],
  ['llms', 'typescript-sdk', 'all'],
  ['llms', 'typescript-sdk', 'bots'],
  ['llms', 'typescript-sdk', 'calendars'],
  ['llms', 'typescript-sdk', 'common'],
  ['llms', 'typescript-sdk', 'webhooks'],
  ['llms', 'typescript-sdk-bots'],
  ['llms', 'typescript-sdk-calendars'],
  ['llms', 'typescript-sdk-common'],
  ['llms', 'typescript-sdk-webhooks'],
